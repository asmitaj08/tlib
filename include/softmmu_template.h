    ...
    if((addr & TARGET_PAGE_MASK) == (tlb_addr & (TARGET_PAGE_MASK | TLB_INVALID_MASK))) {
        if((tlb_addr & TLB_MMIO) == TLB_MMIO) {
            ...
            if(unlikely(cpu->tlib_is_on_memory_access_enabled != 0)) {
                ...
                tlib_on_memory_access(CPU_PC(cpu), MEMORY_IO_READ, addr, (uint64_t)res, sizeof(res)); //fuzz - added sizeof(res)
            }
        ...
        do_unaligned_access:
            ...
            if(unlikely(cpu->tlib_is_on_memory_access_enabled != 0)) {
                tlib_assert(sizeof(res) <= sizeof(uint64_t));
                tlib_on_memory_access(CPU_PC(cpu), is_insn_fetch ? INSN_FETCH : MEMORY_READ, addr, (uint64_t)res, sizeof(res)); //i added sizeof(res) - fuzz
            }
        } else {
            ...
            if(unlikely(cpu->tlib_is_on_memory_access_enabled != 0)) {
                tlib_assert(sizeof(res) <= sizeof(uint64_t));
                tlib_on_memory_access(CPU_PC(cpu), is_insn_fetch ? INSN_FETCH : MEMORY_READ, addr, (uint64_t)res, sizeof(res)); //fuzz - added sizeof(res)
            }
        }
    } else {
    ...
    if((addr & TARGET_PAGE_MASK) == (tlb_addr & (TARGET_PAGE_MASK | TLB_INVALID_MASK))) {
        if((tlb_addr & TLB_MMIO) == TLB_MMIO) {
            ...
            if(unlikely(cpu->tlib_is_on_memory_access_enabled != 0)) {
                ...
                tlib_on_memory_access(CPU_PC(cpu), MEMORY_IO_WRITE, addr, (uint64_t)val, sizeof(val)); // fuzz - added sizeof(res)
            }
        ...
        do_unaligned_access:
            ...
            if(unlikely(cpu->tlib_is_on_memory_access_enabled != 0)) {
                tlib_assert(sizeof(val) <= sizeof(uint64_t));
                tlib_on_memory_access(CPU_PC(cpu), MEMORY_WRITE, addr, (uint64_t)val, sizeof(val)); // fuzz - added sizeof(res)
            }
