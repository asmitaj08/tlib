...
DEFAULT_VOID_HANDLER5(void tlib_on_memory_access, uint64_t pc, uint32_t operation, uint64_t address, uint64_t value, uint32_t access_size) //fuzz - added uint32_t access_size
